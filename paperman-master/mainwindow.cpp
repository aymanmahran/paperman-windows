...
void Mainwindow::saveSettings ()
   ...
   settings.setValue("arrangeby", _arrange_by);
   settings.setValue("sendto", _desktop->getSend());
   settings.setValue("sendemail", _desktop->getEmail());
   _main->closing ();
   }

void Mainwindow::setArrangeBy (int mode){
    _arrange_by = mode;
    _desktop->setArrangeBy(mode);
}
...
void Mainwindow::on_actionByPosition_triggered(bool)
{
    ...
    setArrangeBy(Mainwidget::byPosition);
}
...
void Mainwindow::on_actionByDate_triggered(bool)
{
    ...
    setArrangeBy(Mainwidget::byDate);
}
...
{
    _main->arrangeBy (Mainwidget::byName);
    setArrangeBy(Mainwidget::byName);
}
