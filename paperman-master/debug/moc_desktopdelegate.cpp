...
QT_MOC_LITERAL(6, 53, 17), // "itemDoubleClicked"
QT_MOC_LITERAL(7, 71, 11), // "itemPreview"
QT_MOC_LITERAL(8, 83, 3), // "now"
QT_MOC_LITERAL(9, 87, 17), // "autoRepeatTimeout"
QT_MOC_LITERAL(10, 105, 19), // "slotEditingFinished"
QT_MOC_LITERAL(11, 125, 14), // "Desktopeditor*"
QT_MOC_LITERAL(12, 140, 4), // "edit"
QT_MOC_LITERAL(13, 145, 4) // "save"

    },
    "Desktopdelegate\0itemClicked\0\0QModelIndex\0"
    "index\0which\0itemDoubleClicked\0itemPreview\0"
    "now\0autoRepeatTimeout\0slotEditingFinished\0"
    "Desktopeditor*\0edit\0save"
};
#undef QT_MOC_LITERAL
...
static const uint qt_meta_data_Desktopdelegate[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, 0x80000000 | 3, QMetaType::Int, QMetaType::Bool,    4,    5,    8,
...
void Desktopdelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->itemPreview((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3]))); break;
        case 3: _t->autoRepeatTimeout(); break;
        case 4: _t->slotEditingFinished((*reinterpret_cast< Desktopeditor*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
