...
void Pagemodel::slotSetNum(int num){
    qDebug() << "Num: " << num;
    _num = num;
}
/*
bool Pagemodel::dropMimeData(const QMimeData *data,
    ...
    //return true;
       ...
       // qDebug() << "On: " << column;
        ...
        //_pages.insert(row, rows, Pageinfo());
