...
QT_MOC_LITERAL(4, 28, 4) // "name"
    ...
    "Operation\0progress\0\0percent\0name"
};
...
void Operation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->progress((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Operation::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Operation::progress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Operation::progress(int _t1, QString _t2)
{
