...
#include <memory>
#include "../../paperman-master/dirmodel.h"
...
QT_MOC_LITERAL(1, 9, 15), // "droppedOnFolder"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16), // "const QMimeData*"
QT_MOC_LITERAL(4, 43, 4), // "data"
QT_MOC_LITERAL(5, 48, 8), // "QString&"
QT_MOC_LITERAL(6, 57, 4) // "path"

    },
    "Dirmodel\0droppedOnFolder\0\0const QMimeData*\0"
    "data\0QString&\0path"
};
...
void Dirmodel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Dirmodel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->droppedOnFolder((*reinterpret_cast< const QMimeData*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Dirmodel::*)(const QMimeData * , QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dirmodel::droppedOnFolder)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Dirmodel::staticMetaObject = { {
    QMetaObject::SuperData::link<QDirModel::staticMetaObject>(),
    qt_meta_stringdata_Dirmodel.data,
    qt_meta_data_Dirmodel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void Dirmodel::droppedOnFolder(const QMimeData * _t1, QString & _t2)
{
