...
//    bool getCurrentFile (Desk *&maxdesk, file_info *&file);
   ...
   void setSend(QString dir);

   void compressItems();

   QString getSend(){return _send_path;}

   void setEmail(QString email);

   QString getEmail(){return _send_email;}
   ...
   void selectDir (QModelIndex &index, bool order = false);
...
public slots:
   ...
   void slotSelectIt (QModelIndex &deskInd);

   void slotReorder (int num, int list);

   void slotUpdateCurPos();

   void slotSaveSelected();

   void slotSelectSaved();

   void slotSelectionChanged(int i);

   void slotUpdateEmail();

   void slotItemSendTo(const QModelIndex &index);

   void slotItemTrashFirst(const QModelIndex &index);

   void slotUpdatePosResize (int newWidth);
...
private slots:
   ...
   void dirSelected (const QModelIndex &index, bool allow_undo = true, bool order = false);
